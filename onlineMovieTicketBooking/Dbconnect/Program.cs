...
namespace Dbconnect
{
    class Program
    {
        ...
        private void bookTicket()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("Available Tickets : " + m.AvailableTickets);
            Console.ResetColor();
            Console.ForegroundColor = ConsoleColor.Cyan;
            ...
            if (con == "Yes" || con == "yes")
            {
                ...
                Console.ResetColor();
                Ticket t1 = new Ticket(1, m.MovieName, m.ShowTimings, cId, not, amount, sn);
                tl.NewTicket(t1);
                Console.ForegroundColor = ConsoleColor.Green;
                Console.WriteLine("Id = {0}, MovieName = {1}, Timings = {2}, customerId = {3}, Number of Tickets = {4},AAmount = {5}, Seat Number {6}", 1, m.MovieName, m.ShowTimings, cId, not, amount, sn);
                Console.ResetColor();
                m.AvailableTickets = m.AvailableTickets - not;
                c.WalletAmt = c.WalletAmt - amount;
                Console.ForegroundColor = ConsoleColor.Blue;
                Console.WriteLine("Your Wallet balance is : " + c.WalletAmt);
                Console.ResetColor();
                exit1();
            }
